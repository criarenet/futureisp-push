...
var slideout = new Slideout({
  ...
  'menu': doc.getElementById('hamburgMenu')
});
...
describe('Slideout', function () {
  ...
  it('should add classnames to panel and hamburgMenu DOM elements.', function () {
...
window.onload = function () {
    ...
    document.querySelector('.hamburgMenu').addEventListener('click', function (eve) {
